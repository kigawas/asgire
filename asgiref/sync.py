...
class ThreadSensitiveContext:
    ...
    async def __aexit__(self, exc, value, tb):
        ...
        if executor:
            ...
            # (django/asgiref#535). Join in a dedicated thread, not the loop's
            # default executor: work queued there may itself be needed to
            # unpark the worker, and joins occupying its slots would starve it.
